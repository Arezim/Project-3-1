...
ROOTDIR = "./corosect/corosect/group1/scripts/"
...
if __name__ == "__main__":
    ...
    try:
        ...
        xml_path = './corosect/corosect/group1/scripts/AAS_MRobot_VI_v2Rev3.xml'  # PLEASE CHANGE THE PATH TO THE INFORMATION MODEL (AAS) DELIVERED BY THE HSEL
