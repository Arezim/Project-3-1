...
# add connect state
task1.add(stages.Connect("move to pick", planners))

# add the grasp motioncore
task1.add(pick_and_place.generate_pick(task1,object_name, object_type, "top_down"))

# plan and execute motion
successful = task1.plan()
if not successful:
    pass # TODO implement what to do whewhen planning fails
# STEP 5
...
# joint_name = ['iiwa_joint_1', 'iiwa_joint_2', 'iiwa_joint_3', 
#                                     'iiwa_joint_4', 'iiwa_joint_5', 'iiwa_joint_6', 
#                                     'iiwa_joint_7', 'm_robot_linear_drive_guiderail_sledge_joint',
