...
class JointActivityPublisher:
    ...
    def __init__(self) -> None:
        ...
        sync_sub = message_filters.ApproximateTimeSynchronizer([
            ...
            message_filters.Subscriber('linear_extension/teknic/joint_activity', JointActivity),
            message_filters.Subscriber('linear_extension/dynamixel/joint_activity', JointActivity),
