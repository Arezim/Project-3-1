...
ROOTDIR = "./corosect/corosect/m_robot_moveit_config/scripts/"
...
if __name__ == "__main__":
    ...
    try:
        ...
        xml_path = './corosect/corosect/m_robot_moveit_config/scripts/AAS_MRobot_VI_v2Rev3.xml'  # PLEASE CHANGE THE PATH TO THE INFORMATION MODEL (AAS) DELIVERED BY THE HSEL
