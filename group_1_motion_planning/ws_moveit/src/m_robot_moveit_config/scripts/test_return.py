...
class threading_tranding():
    ...
    def vi_task(self):
        ...
        project = r'/home/moveit/corosect_ws/src/corosect/corosect/m_robot_moveit_config/scripts/'
        name = f'output_results/{users_folder}'
        image_path = '/home/moveit/corosect_ws/src/corosect/corosect/m_robot_moveit_config/scripts/UEYEcam/capture_frames/rgb_input/frame_01.png'
        ...
        shutil.copyfile(project+name+"/output.json","/home/moveit/corosect_ws/src/corosect/corosect/m_robot_moveit_config/scripts/VI_results/output.json")
