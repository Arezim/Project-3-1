...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /root/test/motion-planning-1/ws/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /root/test/motion-planning-1/ws/devel/.private/moveit_tutorials)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /root/test/motion-planning-1/ws/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  if(NOT "https://github.com/moveit/moveit_tutorials/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/moveit/moveit_tutorials/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "https://moveit.github.io/moveit_tutorials " STREQUAL " ")
    set(_report "Check the website 'https://moveit.github.io/moveit_tutorials' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/test/motion-planning-1/ws/src/moveit_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/test/motion-planning-1/ws/devel/.private/moveit_tutorials/lib;/root/test/motion-planning-1/ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(moveit_tutorials_EXPORTED_TARGETS ${${moveit_tutorials_dep}_EXPORTED_TARGETS})
endforeach()
