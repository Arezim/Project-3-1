...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /root/test/motion-planning-1/ws/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /root/test/motion-planning-1/ws/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /root/test/motion-planning-1/ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/test/motion-planning-1/ws/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/test/motion-planning-1/ws/devel/.private/catkin_tools_prebuild/lib;/opt/ros/noetic/lib)
