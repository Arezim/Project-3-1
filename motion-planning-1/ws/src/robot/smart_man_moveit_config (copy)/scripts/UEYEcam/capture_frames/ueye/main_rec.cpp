...
const std::string parameters_file="/home/moveit/corosect_ws/src/corosect/corosect/smart_man_moveit_config/scripts/UEYEcam/capture_frames/ueye/parameters/presetParams.ini";
